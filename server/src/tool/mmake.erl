...
%%get_compile_files(Files,Opts) ->
%%    Extension = code:objfile_extension(),
%%    F = fun(File) ->
%%        ObjName = lists:append(filename:basename(File), Extension),
...
%%                if
%%                    Erl#file_info.mtime > Obj#file_info.mtime ->
%%                        true;
%%                    true ->
%%                        false
%%                end;
